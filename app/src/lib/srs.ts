...
// et UNE carte par élément : un mot a une échéance, pas une par compétence — c'est la forme
// de l'exercice qui varie d'un passage à l'autre (cf. lib/vocabDrills.ts).
